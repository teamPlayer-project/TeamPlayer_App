...
public class city extends AppCompatActivity {
    ...
    ScrollChoice scrollChoice_city;
    String dataToSave_city;
    Button buttonDone_city;
    String classBack;
    String activityName;
    String age;
    String sport_type;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scrollChoice_city = (ScrollChoice)findViewById(R.id.city_scroll);
        buttonDone_city = (Button) findViewById(R.id.done_city);
        ...
        buttonDone_city.setOnClickListener(new View.OnClickListener(){
            //@override
            public void onClick(View v){
                if(classBack.equals("activity_create_new")) {
                    Intent intent = new Intent(city.this, activity_create_new.class);
                    intent.putExtra("CITY", dataToSave_city);
                    ...
                    if (classBack.equals("activity_Search")){
                        Intent intent = new Intent(city.this, activity_Search.class);
                        intent.putExtra("CITY", dataToSave_city);
                        intent.putExtra("AGE", age);
                        intent.putExtra("SPORTS", sport_type);
                        startActivity(intent);
    ...
    public void continueLoad() {
        scrollChoice_city.addItems(cities, 15);
        scrollChoice_city.setOnItemSelectedListener(new ScrollChoice.OnItemSelectedListener() {
            @Override
            public void onItemSelected(ScrollChoice scrollChoice, int position, String name) {
                dataToSave_city = name;
            }
        });
    }
